    ...
    const initGoogle = () => {
      ...
      try {
        ...
        if (buttonContainer) {
          ...
          customBtn.className = 'w-full px-4 py-3 bg-white border-2 border-gray-200 rounded-xl font-semibold text-gray-900 hover:border-gray-300 hover:bg-gray-50 transition-all duration-200 flex items-center justify-center gap-3 hover:shadow-md active:scale-95';
